...
@section('content')
    <div class="space-y-8 max-w-4xl mx-auto">
        ...
        <div class="flex items-center gap-4 pb-2 border-b border-zinc-200 dark:border-zinc-700">
            ...
            <div class="flex-1">
                <flux:heading size="xl" class="!mb-1">Tambah Proyek</flux:heading>
                <flux:subheading class="!mt-0">Tambah proyek baru ke portfolio</flux:subheading>
            </div>
        </div>
            ...
            <form action="{{ route('projects.store') }}" method="POST" enctype="multipart/form-data" class="space-y-8">
                ...
                <div class="space-y-6">
                    ...
                    <flux:field>
                        ...
                        <flux:input name="name" value="{{ old('name') }}" placeholder="Masukkan nama proyek" required class="!rounded-xl !border-zinc-300 dark:!border-zinc-600" />
