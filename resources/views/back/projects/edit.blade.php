...
@push('css')
    <style>
        /* Similar styles as in create view */
        .file-input-label {
        ...
        <form action="{{ route('projects.update', $project->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <div class="current-picture-container">
                    ...
                    <img src="{{ asset('storage/' . $project->image) }}" alt="Project Image" class="current-picture">
                </div>
            </div>

            <div class="mb-3 image-size-option">
                <label>Image Size</label><br>
                <input type="radio" id="small" name="image_size" value="small" {{ $project->image_size === 'small' ? 'checked' : '' }} required>
                <label for="small">Small</label><br>
                <input type="radio" id="large" name="image_size" value="large" {{ $project->image_size === 'large' ? 'checked' : '' }}>
