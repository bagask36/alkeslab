...
@section('content')
    <div class="container-fluid" id="content">
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Buat Teknis Medis Baru</h1>
        </div>
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
            ...
            <form action="{{ route('teknis.store') }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-6">
                        <div class="mb-3">
                            <label for="name">Nama Teknis</label>
