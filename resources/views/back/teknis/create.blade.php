...
@section('content')
    <div class="space-y-8 max-w-4xl mx-auto">
        ...
        <div class="flex items-center gap-4 pb-2 border-b border-zinc-200 dark:border-zinc-700">
            ...
            <div class="flex-1">
                <flux:heading size="xl" class="!mb-1">Tambah Teknis</flux:heading>
                <flux:subheading class="!mt-0">Tambah data teknis dan spesialisasi baru</flux:subheading>
            </div>
        </div>

        <!-- Form -->
        <flux:card class="!p-8 !shadow-lg !border-zinc-200 dark:!border-zinc-700">
            <form action="{{ route('teknis.store') }}" method="POST" enctype="multipart/form-data" class="space-y-8">
                @csrf
                ...
                <div class="space-y-6">
                    ...
                    <flux:field>
                        ...
                        <flux:input name="name" value="{{ old('name') }}" placeholder="Masukkan nama teknis" required class="!rounded-xl !border-zinc-300 dark:!border-zinc-600" />
