            ...
            return DataTables::of($data)
                ...
                ->addColumn('action', function ($article) {
                    ...
                    return '<div class="flex items-center gap-2">
                                <a href="'.$viewUrl.'" class="action-icon" data-tooltip="Lihat Detail">
                                ...
                                <form action="'.$deleteUrl.'" method="POST" style="display:inline;" class="action-icon-form">
                                    '.$csrf.'
                                    '.$method.'
                                    <button type="submit" class="action-icon" data-tooltip="Hapus" onclick="return confirm(\'Apakah Anda yakin ingin menghapus artikel ini?\')">
